...
class ModelAdmin:
    ...
    # Form configuration
    form_fields: list[str] | None = None  # Explicit field order
    ...
    def has_update_permission(self, user: Any, obj: Any | None = None) -> bool:
        """
    ...
    def has_delete_permission(self, user: Any, obj: Any | None = None) -> bool:
        """
