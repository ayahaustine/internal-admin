...
class QueryEngine:
    ...
    def _apply_search(self, query: Query, search_query: Optional[str]) -> Query:
        """
    ...
    def _apply_filters(self, query: Query, filters: Optional[Dict[str, Any]]) -> Query:
        """
    ...
    def _apply_ordering(self, query: Query, ordering: Optional[List[str]]) -> Query:
        """
