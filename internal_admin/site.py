...
from .auth.routes import create_auth_router, get_current_user
...
class AdminSite:
    ...
    def __init__(self, config: AdminConfig) -> None:
        ...
        self._router_factory: AdminRouterFactory | None = None
    ...
    def register(
        self,
        model: type[Any],
        model_admin_class: type[ModelAdmin] | None = None
    ) -> None:
        """
